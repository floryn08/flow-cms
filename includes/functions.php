...
//        var_dump(mysqli_fetch_array($page_set));

//        $output .= "<button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"menu1\" data-toggle=\"dropdown\"><span class=\"caret\"></span></button>";
        $output .= "<a class='dropdown-toggle' data-toggle=\"dropdown\"><span class='caret'></span></a>";
